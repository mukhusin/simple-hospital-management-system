...
return new class extends Migration
{
    ...
    {
        // Note: intentional typo 'attandance' preserved from legacy DB
        if (!empty(DB::select("SHOW TABLES LIKE 'attandance_movement_data'"))) {
            return;
        }
        Schema::create('attandance_movement_data', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('attandance_movement_data');
    }
};
