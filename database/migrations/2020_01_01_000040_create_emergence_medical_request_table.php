...
return new class extends Migration
{
    ...
    {
        if (!empty(DB::select("SHOW TABLES LIKE 'emergence_medical_request'"))) {
            return;
        }
        Schema::create('emergence_medical_request', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('emergence_medical_request');
    }
};
